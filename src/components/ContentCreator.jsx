...
const ContentCreator = () => {
    ...
    <section id="creator" className="bg-[#0a0a0a] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px]">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-5.5xl font-medium leading-relaxed">
  ...
  viewBox="0 0 24 24"
>
  <path d="M20.52 3.48A11.82 11.82 0 0012.03 0C5.4 0 .03 5.37.03 12c0 2.11.55 4.17 1.59 5.99L0 24l6.18-1.61A11.94 11.94 0 0012.03 24C18.66 24 24 18.63 24 12c0-3.18-1.24-6.17-3.48-8.52z"/>
</svg>
