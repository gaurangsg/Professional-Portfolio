...
const ProjectCard = ({ project, aosDelay }) => (
  ...
  >
    <div className={`rounded-2xl p-6 md:p-8 h-full backdrop-blur-md transition-all duration-500 ${
      ...
      {/* Description */}
      <p className="text-white/60 text-sm md:text-base leading-relaxed mb-6 max-w-5xl font-medium">
        {project.description}
      </p>
  ...
  <img
    src={project.image}
    alt={project.title}
    className=" w-[1000px] h-[600px] mx-auto rounded-xl mb-6 border border-white/10
    -translate-y-[10px]
  "
  />
)}
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {project.links.demo !== undefined && (
          <a 
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 ${
              project.links.demo 
                ? ' bg-white/10 text-white hover:bg-white hover:text-black transition-all duration-300 group/btn'
        ...
        {project.links.frontendDemo && (
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 rounded-full  bg-white/10 text-white text-sm font-semibold hover:bg-white hover:text-black transition-all duration-300 group/btn"
          >
            <ExternalLinkIcon />
            Visit Site
          </a>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] mb-6 tracking-tight">
            THE ART OF 🎨 <br className="hidden md:block" /> DIGITAL CRAFTSMANSHIP!
          </h2>
          <p className="text-white/50 text-base md:text-lg max-w-3xl font-medium leading-relaxed">
            A curated collection of Full-Stack Applications, AI-powered solutions, and digital experiences where CRAFTSMANSHIP meets ENGINEERING EXCELLENCE!
          </p>
        </div>
